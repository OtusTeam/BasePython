...
def create_author_for_user(session: SessionType, user: User, author_name: str) -> Author:
...
def create_posts_for_author(session: SessionType, author: Author, titles: List[str]) -> List[Post]:
