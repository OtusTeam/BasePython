...
FROM articles
         LEFT OUTER JOIN users AS users_1
                         ON users_1.id = articles.author_id
...
SELECT articles.author_id    AS articles_author_id
...
FROM articles
WHERE articles.author_id IN (1, 2, 3);
...
SELECT articles.author_id    AS articles_author_id
     ...
     , articles.id           AS articles_id
FROM articles
WHERE articles.author_id IN (1, 3)
