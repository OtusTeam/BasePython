...
from animals.models import Animal, Category, Food
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        Food.objects.create(title='banana')
        Food.objects.create(title='meat')
        Food.objects.create(title='honey')

        self.stdout.write(self.style.SUCCESS("Hello command"))
