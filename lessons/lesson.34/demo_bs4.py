...
print("print_posts_links(soup)")
print_posts_links(soup)
...
print("similar_posts")
print(similar_posts)
# print(similar_posts.text)

print("print_posts_links(similar_posts)")
print_posts_links(similar_posts)
...
print("print_posts_links(similar_posts_header.parent.parent)")
print_posts_links(similar_posts_header.parent.parent)
